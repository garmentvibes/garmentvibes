...
create table retail_product_sizes (
  id uuid primary key default gen_random_uuid(),
...
create index retail_products_category_idx on retail_products (category);
...
create index wholesale_products_category_idx on wholesale_products (category);
...
create table wholesale_quote_items (
  id uuid primary key default gen_random_uuid(),
